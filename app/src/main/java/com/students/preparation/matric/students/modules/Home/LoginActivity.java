                    ...
                    databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if (logOnstudent.size()<=0){
                                ...
                                Toast.makeText(getApplicationContext(),"Unapproved or unregistered Number. If you have registered recently please wait for approval.",Toast.LENGTH_LONG).show();
                            }else {
