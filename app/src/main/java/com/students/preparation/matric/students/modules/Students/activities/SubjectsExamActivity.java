...
public class SubjectsExamActivity extends AppCompatActivity {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot tutorialSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if (uploadsModel.getExamSubject().equalsIgnoreCase(subjects)&& uploadsModel.getExamType().equalsIgnoreCase(getExamType())){
    ...
    public  String getExamType(){
        SharedPreferences preferences = getApplicationContext().getSharedPreferences("Images",0);
        return preferences.getString("examType","");
    }
}
